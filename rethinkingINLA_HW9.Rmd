...
m1.1.i <- inla(use.contraception ~  0+ f(a.did, model="iid2d", n= 2*n.district) + f(b.did, urban, copy= "a.did"), data= d1.i, family = "binomial", 
              Ntrials = 1, 
              #control.fixed = list(
        #mean= 0,
        #prec= 1/(0.5^2), 
...
m1.1.i.mean <- bind_cols(did= 1:length(m1.1.i.a.mean), mean= m1.1.i.a.mean) %>% 
