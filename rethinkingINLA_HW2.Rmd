...
#That said, you can do it if you want. It would be

#f(index, covariate, model="iid", hyper=list(prec=list(........)))
prec.prior <- list(prec = list(prior = "logtgaussian", param = c(0, 1)))

m2.i<- inla(height ~ 1+ f(idx, log_w, model = "iid", hyper = prec.prior), 
            data= d2.i,
            control.fixed = list(
       # mean= 0, 
       # prec= 1, 
